            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        <a href="/login" class="text-gray-700 hover:text-green-600 font-medium transition duration-300">Sudah punya akun?</a>
            ...
            <div class="max-w-md w-full">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">Daftar untuk mengakses layanan kami</p>
                    </div>
                    ...
                    <div class="mt-6 text-center md:hidden">
                        ...
                        <a href="/login" class="text-green-600 font-medium hover:text-green-700 transition duration-300">
                            Masuk sekarang
                        </a>
                    </div>
                </div>
